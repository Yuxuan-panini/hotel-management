...
@WebServlet(name = "getareahotelreportop",urlPatterns = {"/getareahotelreportop"})
public class GetAreaHotelReporTopServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AddressReport result = GeneralManagerDao.printAddressReport(area);
        if (result!=null) {
