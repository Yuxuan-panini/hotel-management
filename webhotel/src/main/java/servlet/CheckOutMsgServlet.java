...
public class CheckOutMsgServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<String> result= ReceptionDao.watchCheckoutBill(consumer_id);
        if (!result.isEmpty()) {
            ...
            System.err.println("Check out msg not exist");
