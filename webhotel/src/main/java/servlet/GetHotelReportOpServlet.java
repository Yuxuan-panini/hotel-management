...
@WebServlet(name = "/gethotelreportop",urlPatterns = {"/gethotelreportop"})
public class GetHotelReportOpServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HotelListInfo result= ManagerDao.printReport(staffId);
        if (result!=null) {
