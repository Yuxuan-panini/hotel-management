...
@WebServlet(name = "/addstaffhotel",urlPatterns = {"/addstaffhotel"})
public class AddStaffHotelServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean result=GeneralManagerDao.attachHotel(hotel_id,staff_id);
        if (result) {
