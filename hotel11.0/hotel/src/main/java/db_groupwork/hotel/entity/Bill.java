...
public class Bill {
    ...
    public Bill(int customerId, int hotelId, Timestamp bookTime, Timestamp checkin, Timestamp checkout, int expectedStayDays, String roomType){
        ...
        this.billFee = Room.fee.get(roomType)*expectedStayDays;
